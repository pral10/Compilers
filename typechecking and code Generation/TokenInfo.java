...
enum TokenKind {
    ...
    VOID("void"), WHILE("while"), BREAK("break"), CASE("case"), CATCH("catch"), CONTINUE(
            "continue"), DEFAULT("default"), DO("do"), DOUBLE("double"), FINALLY("finally"),
    ...
    MINUS("-"), PLUS("+"), PLUS_ASSIGN("+="), STAR("*"), DIV("/"), REM("%"), IOR("|"), IXOR("^"),
    IAND("&"), INOT("~"), ALS("<<"), ARS(">>"), LRS(">>>"), QUESTION("?"),
    COLON(":"), NOT_EQUAL("!="), DIV_ASSIGN("/="), MINUS_ASSIGN("-="), STAR_ASSIGN("*="),
    REM_ASSIGN("%="),
    ARSHIFT_ASSIGN(">>="), LRSHIFT_ASSIGN(">>>="), GE(">="), ALSHIFT_ASSIGN("<<="), LT("<"),
    XOR("^"), XOR_ASSIGN("^="), OR_ASSIGN("|="), LOR("||"), AND_ASSIGN("&="),
