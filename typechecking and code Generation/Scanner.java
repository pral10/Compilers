        ...
        while (moreWhiteSpace) {
            ...
            if (ch == '/') {
                ...
                if (ch == '/') {
                    ...
                    return new TokenInfo(DIV,line); // saying that this Token is a Divison in
                    // this line
                }
            } else {
        ...
        switch (ch) {
            ...
            case '^':
                ...
                if (ch == '=')
                {
                    ...
                    return new TokenInfo(IXOR, line);
                }
            case '~':
                nextCh();
                return new TokenInfo(INOT, line);
            case '&':
                nextCh();
                if (ch == '&') {
                    nextCh();
                    ...
                    return new TokenInfo(IAND, line);
                }
            case '?':
                nextCh();
